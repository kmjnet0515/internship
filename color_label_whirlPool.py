...
folder_path = 'saved_frames5'
output_path = 'saved_frames5'  # txt 파일도 같은 폴더에 저장
...
for img_file in image_files:
    ...
    if contours:
        ...
        for i, cnt in enumerate(largest_two):
            ...
            # YOLO 라벨 문자열 생성
            yolo_line = f"4 {x_center_norm:.6f} {y_center_norm:.6f} {w_norm:.6f} {h_norm:.6f}"
